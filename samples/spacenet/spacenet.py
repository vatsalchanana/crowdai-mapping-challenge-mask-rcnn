...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    # Get color splashed data
    python3 spacenet.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>
...
class SpacenetConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + roofs
...
class SpacenetDataset(utils.Dataset):
    ...
    def load_spacenet(self, dataset_dir, subset):
